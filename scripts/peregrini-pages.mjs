...
export function writePeregriniPages({root,assetVersion,config,language,cards}){
  const nav=`<a href="./index.html">Escritos em Peregrini</a><a href="./idioma.html">Letras e leitura</a><a href="./idioma.html#vocabulario">Vocabulário</a><a href="../index.html">Arquivo geral</a>`;
...
<div class="language-table-wrap" role="region" tabindex="0" aria-label="Alfabeto e exemplos de pronúncia"><table><caption>Combinações e exemplos vocálicos</caption><thead><tr><th scope="col">Maiúscula</th><th scope="col">Minúscula</th><th scope="col">Pronúncia</th><th scope="col">Combinações e exemplos vocálicos em português</th></tr></thead><tbody>${alphabet}</tbody></table></div>
<p class="table-note">Exemplos transcritos do <em>Alfabeto Peregrini Oficial</em>, versão 5, de 24 de agosto de 2026. As palavras em português são aproximações didáticas de pronúncia e não acrescentam regras do português à ortografia Peregrini.</p>
