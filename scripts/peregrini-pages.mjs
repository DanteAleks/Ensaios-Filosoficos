...
<p class="table-note">As palavras em português são aproximações sonoras, que podem variar com o sotaque. Cada exemplo é uma palavra única escolhida para tornar o som mais reconhecível; elas ajudam a ler as letras e não acrescentam palavras ao vocabulário.</p>
