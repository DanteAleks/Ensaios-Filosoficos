(() => {
  const fonts={classica:"Georgia, 'Times New Roman', serif",livro:"Palatino, 'Palatino Linotype', 'Book Antiqua', serif",peregrini:"'Palavra Peregrini Texto', Georgia, serif",simples:'Arial, Helvetica, sans-serif'};
